...
![Shortcuts screenshot](./img/qr-code-first-screen.png "Side-by-side screenshots of the Shortcuts app, displaying the scripted prototype of the application I built")
...
There are a handful of things to note for somebody who has never traveled down this path before, namely:
