...
My class tends towards people who are early or mid career and are attempting to either pivot into the field of data science, or become more skilled/literate with data analysis and use that to level up there already extant subject-matter expertise.</details>


### ❓ What is it like to move from a non-tech industry to a technology-forward job/the tech industry?

<details><summary><b>I won't sugarcoat it: it's challenging.</b></summary> You'll likely have to work harder than folks who have taken a four-year degree in the subject or have working experience.</details>

<details>In the incredibly competitive professional landscape of the current moment, a credential is no longer demonstration that you can do the work related to the job. <summary><b>Doing the work</b> is a demonstration you can do the work, not a degree. This means if we're coming into an industry anew and still acculturating ourselves to what "the work" is, we are at a disadvantage.</summary> Unfortunately, this is a fractal problem, and it will take you some time to catch up--this is where impostor syndrome comes from. But thankfully, you're not alone in this process, and most other early career folks are also pretending to feel confident in their competence to get by.</details>

### 🙋‍♀️ What do companies look for when hiring? 
<details><summary>Ultimately it's hard to say, but it is very much dependent on the size of the company, the macroeconomic landscape, and other factors outside your control. In my experience, demonstrating you can learn quickly and that you have ~60-80% of the skills in the job description are the most important attributes. Also, being personable, open to experience, and not being afraid to ask questions.</summary><br>

When trying to get into my first job out of grad school I did a very niche project for folks and that demonstrated that--while I didn't have deep expertise in the domain--I could quickly become conversant in new ideas that I would be introduced to. I asked questions that were naive, but didn't take myself too seriously, and I found that there was strong cultural alignment with the people I would end up working with.
...
I have mostly done hiring at smaller organizations, so it tends to be higher-touch experience than at a large tech company, and you can use that to your advantage.
</details>
...
It's important to remember that "getting the job" and "doing the job" are separate jobs entirely. They require different skills, and you have to play both games seriously to win.
...
Typically I weight an ongoing programming or data analysis project higher than I would a one-off, because it demonstrates consistent engagement with an idea over time, but I don't discount anybody for having tons of small projects <i>if they are all complete</i>. Personally, I also don't discount people using AI as part of this, provided they're explicit in which work the LLM performed vs. the work the author did.
</details>
